  ...
  return (
    <section className="bg-white text-gray-800 py-16 px-6 md:px-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mt-10 mb-4">💬 What is Chatify?</h3>
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mt-10 mb-4">🌍 Why Chatify?</h3>
        <p className="text-base leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mt-10 mb-4">🚀 Join the Conversation</h3>
        <p className="text-base leading-relaxed mb-6">
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg font-semibold text-gray-800 mt-1">Let’s talk. Let’s Chatify. 💜</p>
        </div>
      </div>
    </section>
  );
