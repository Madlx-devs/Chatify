...
public class MessageServiceImpl {
    ...
    public MessageDto sendMessage(MessageRequest messageRequest, AppUserDetails userDetails)throws UsernameNotFoundException, RoomNotFoundException, TopicNotFoundException {
